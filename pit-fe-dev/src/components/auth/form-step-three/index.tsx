...
const FormStepThree = ({
  ...
  const onSubmit = async () => {
    try {
      ...
      formData.append("phoneNo", formState.phoneNo);
      formData.append("name", formState.name);
      formData.append("email", formState.email);
      formData.append("pan", formState.pan);
      formData.append("aadhaar", formState.aadhaar);
      formData.append("monthlyIncome", formState.monthlyIncome.replaceAll("₹", ""));
      formData.append("loanAmountRequired", formState.loanAmountRequired.replaceAll("₹", ""));
      ...
      await axiosInstance.post(`/customer/create-lead`, formData.toString(), {
        headers: {
